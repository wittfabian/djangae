...
- Updated `djangae.contrib.backup` to use the new export API (the existing API will be deprecated in Feb 2018). This adds a dependency of `google-auth` and `google-api-python-client`,
